...
1. 点击![在这里插入图片描述](学习笔记（二）.assets/a46815a94e00437ab393b1049b1114f5.png)生成lua文件
2. 添加unlua的接口![在这里插入图片描述](学习笔记（二）.assets/e1ae8d0a5ee040339deb8ece921ebcd0.png)
3. 添加返回路径，以Script为根路径，文件层级之间用点（.）隔开![在这里插入图片描述](学习笔记（二）.assets/cd6937dec246450a9720c0a0f2892377.png)
...
![在这里插入图片描述](学习笔记（二）.assets/9b28daa7a5934199a44595cb33979a11.png)
...
![在这里插入图片描述](学习笔记（二）.assets/90191d04f861451fbe61d0ca3b7c6f8c.png)
...
![在这里插入图片描述](学习笔记（二）.assets/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBAcXFfNDkzMjM1MzM=,size_20,color_FFFFFF,t_70,g_se,x_16-1640878310209488.png)
...
```lua
local WeaponClass = UE4.UClass.Load("/Game/BluePrint/FPWeapon/BP_DefaultWeapon.BP_DefaultWeapon")
	local NewWeapon =World:SpawnActor(WeaponClass,self:GetTransform(),UE4.ESpawnActorCollisionHandlingMethod.AlwaysSpawn,self,self,"Blueprint.FPWeapon.BP_DefaultWeapon_C")--最后一个参数是在spawn的时候动态绑定
```
